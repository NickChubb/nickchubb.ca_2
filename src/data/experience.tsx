...
export const experienceData: ExperienceData = [
  {
    ...
    skills: ['TypeScript', 'JavaScript', 'ReactJS', 'Next.js', 'HTML', 'CSS', 'Redux'],
  ...
  },
  {
    ...
    skills: ['JavaScript', 'HTML', 'CSS', 'Liquid'],
  ...
  },
  {
    ...
    skills: ['Java', 'JUnit', 'CI/CD', 'Selenium', 'Unit Testing', 'End-to-end Testing'],
